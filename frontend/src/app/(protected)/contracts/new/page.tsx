...
export default function NewContractPage() {
  ...
  const { data: vendorsData } = useSWR<{
    ...
    currentOrganization?.id ? '/api/contracts/vendors?limit=200' : null,
    fetcher
  );
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (form.sla_response_hours)
      key_terms.sla_response_hours = Number(form.sla_response_hours);
    if (form.uptime_guarantee)
      key_terms.uptime_guarantee = form.uptime_guarantee;
    ...
    try {
      const res = await api.post<{ id: string }>('/api/contracts', payload);
      router.push(`/contracts/${res.id}`);
    } catch (e: unknown) {
      setError(errorMessage(e, 'Failed to create contract'));
      setSaving(false);
    }
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Add a contract or agreement to your vault
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="col-span-full">
              ...
              {form.auto_renews && (
                <p className="mt-1.5 text-xs text-amber-400">
                  CASPER will alert you {form.renewal_notice_days || 30} days
          ...
          <Section title="Key Terms (optional)">
            ...
            <div className="col-span-full">
              ...
              <input
                ...
                onChange={e => set('uptime_guarantee', e.target.value)}
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-600 mt-1.5">
              Paste a link to the signed contract PDF.
            </p>
          </div>
