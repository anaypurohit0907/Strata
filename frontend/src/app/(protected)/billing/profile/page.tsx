        ...
        >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  PNG, JPG — max 2 MB. Appears top-left of every invoice.
                </p>
              </div>
            </div>
          </Section>
          ...
          <Section title="Company Information">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Field label="City">
                <Input
                  ...
                  onChange={e => upd('company_city', e.target.value)}
                />
              </Field>
              <Field label="State / Region">
                <Input
                  value={form.company_state ?? ''}
                  onChange={e => upd('company_state', e.target.value)}
                />
              </Field>
              <Field label="ZIP / Postal">
                <Input
                  value={form.company_zip ?? ''}
                  onChange={e => upd('company_zip', e.target.value)}
                />
              </Field>
            </div>
            <Row>
              <Field label="Country">
                <Input
                  value={form.company_country ?? 'US'}
                  onChange={e => upd('company_country', e.target.value)}
                  placeholder="US"
                />
              </Field>
              <Field label="Tax ID Label">
                <Input
                  value={form.tax_label ?? 'Tax ID'}
                  onChange={e => upd('tax_label', e.target.value)}
                  placeholder="GST No / VAT No / EIN"
                />
              </Field>
            </Row>
            <Field label="Tax ID / VAT / GST Number">
              <Input
                value={form.tax_id ?? ''}
                onChange={e => upd('tax_id', e.target.value)}
            ...
            <div className="grid grid-cols-3 gap-4">
              <Field label="Invoice Prefix">
                <Input
                  ...
                  onChange={e => upd('invoice_prefix', e.target.value)}
                  placeholder="INV"
                  maxLength={8}
                />
              </Field>
              ...
              <Field label="Payment Terms (days)">
                <Input
                  ...
                  onChange={e =>
                    upd('payment_terms_days', parseInt(e.target.value) || 30)
                  }
                />
              </Field>
            </div>
            ...
            <Row>
              ...
              <Field label="Beneficiary Name">
                <Input
                  ...
                  onChange={e => upd('bank_beneficiary', e.target.value)}
                  placeholder="Acme Corp Ltd."
                />
              </Field>
            </Row>
            <Row>
              ...
              <Field label="Routing / Sort Code">
                <Input
                  ...
                  onChange={e => upd('bank_routing', e.target.value)}
                />
              </Field>
            </Row>
            <Row>
              <Field label="SWIFT / BIC">
                <Input
                  ...
                  onChange={e => upd('bank_swift', e.target.value)}
                  placeholder="FNBKUS44XXX"
                />
              </Field>
              <Field label="IBAN">
                <Input
                  value={form.bank_iban ?? ''}
                  onChange={e => upd('bank_iban', e.target.value)}
          ...
          <Section title="Signature & Footer">
            <Row>
              <Field label="Signatory Name">
                <Input
                  ...
                  onChange={e => upd('signature_name', e.target.value)}
              ...
              <Field label="Signatory Title">
                <Input
                  ...
                  onChange={e => upd('signature_title', e.target.value)}
                  placeholder="CFO"
                />
              </Field>
            </Row>
            <Field label="Footer Text (appears at bottom of invoice)">
              <Textarea
                ...
                onChange={e => upd('footer_text', e.target.value)}
