  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (const k of [
        ...
        if (formValues[k]) specs[k] = formValues[k];
      }
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onChange={v => upd('condition_rating', v)}
                options={CONDITIONS}
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={v => upd('serial_number', v)}
                placeholder="SN-XXXX"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={v => upd('purchase_date', v)}
                type="date"
              />
            </div>
            <div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  onChange={v => upd('purchase_price', v)}
                  placeholder="0.00"
                  type="number"
                  step="0.01"
                />
            ...
            <div>
              ...
              <Input
                ...
                onChange={v => upd('invoice_number', v)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={v => upd('depreciation_years', v)}
                type="number"
                min="1"
                max="20"
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={v => upd('warranty_expiry', v)}
                type="date"
              />
            </div>
            <div>
              ...
              <Select
                ...
                onChange={v => upd('warranty_type', v)}
            ...
            <div className="col-span-2">
              ...
              <Input
                ...
                onChange={v => upd('warranty_notes', v)}
                placeholder="e.g. Includes accidental damage cover"
              />
            </div>
          </div>
        </Section>
              ...
              {tags.length > 0 && (
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {tags.map(t => (
                    <span
                      key={t}
                      className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs bg-muted border border-border text-muted-foreground"
                    >
                      {t}
                      <button
                        type="button"
