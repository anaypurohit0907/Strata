  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const body: Record<string, unknown> = {
        ...
        cost_per_year: form.cost_per_year
          ? parseFloat(form.cost_per_year)
          : null,
      ...
      const lic = await api.post<{ id: string }>(
        '/api/assets/licenses',
        body,
        orgId
      );
      ...
      setError(errorMessage(err, 'Failed to create license'));
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  value={form.cost_per_year}
                  onChange={v => upd('cost_per_year', v)}
                  type="number"
                  step="0.01"
                  placeholder="0.00"
                />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Stored encrypted. Only visible to admins.
              </p>
            </div>
            <div>
              ...
              <Input
                ...
                onChange={v => upd('vendor_contact', v)}
