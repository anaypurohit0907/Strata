...
export default function NewAssetPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(errorMessage(err, 'Failed to create asset'));
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => upd('asset_tag', e.target.value)}
            ...
            <div>
              ...
              <select
                ...
                onChange={e => upd('condition_rating', e.target.value)}
                className="w-full px-3 py-2 text-sm bg-muted/40 border border-border rounded-lg focus:outline-none text-foreground capitalize"
              >
                {CONDITIONS.map(c => (
                  <option key={c} value={c}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => upd('invoice_number', e.target.value)}
                className="w-full px-3 py-2 text-sm bg-muted/40 border border-border rounded-lg focus:outline-none focus:border-primary/50 font-mono"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={e => upd('warranty_expiry', e.target.value)}
                className="w-full px-3 py-2 text-sm bg-muted/40 border border-border rounded-lg focus:outline-none focus:border-primary/50"
              />
            </div>
            <div>
              ...
              <select
                ...
                onChange={e => upd('warranty_type', e.target.value)}
                className="w-full px-3 py-2 text-sm bg-muted/40 border border-border rounded-lg focus:outline-none text-foreground capitalize"
              >
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                onChange={e => upd('warranty_notes', e.target.value)}
                className="w-full px-3 py-2 text-sm bg-muted/40 border border-border rounded-lg focus:outline-none focus:border-primary/50"
