...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    period: '/ month',
    description:
      'For growing IT teams that need automation, incidents, and cost control.',
    cta: 'Start Business',
  ...
  },
  {
    ...
    period: 'pricing',
    description:
      'For large orgs with compliance, SSO, and HR automation needs.',
    badge: 'Contact us',
...
const WHY_STRATA = [
  {
    ...
    body: 'CASPER is the connective tissue of every module — not a chatbot you added later.',
  },
  {
    icon: Layers,
    title: 'One platform, 13 modules',
    body: 'Replace 8 disconnected tools with a single workspace your team actually uses.',
  },
  {
    icon: Shield,
    title: 'SME-grade security',
    body: 'Row-level security, full audit log, and rate-limited AI on every plan.',
  },
  {
    icon: Users,
    title: 'Built for small IT teams',
    body: 'No ITIL bloat. No 6-month implementation. Up and running in 20 minutes.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        ...
        <div className="text-center space-y-4 py-8">
          <h2 className="text-2xl font-bold">
            Ready to consolidate your IT stack?
          </h2>
          <p className="text-muted-foreground">
            Join teams that replaced 8+ tools with one platform.
          </p>
